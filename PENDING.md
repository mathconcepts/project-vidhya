...
Thirteen items moved from pending → done (11 backend/infra + 2 frontend pages in follow-ups). The sections below show the full remaining list. Seventeen more items shipped in subsequent commits and are listed at the bottom of this banner.
