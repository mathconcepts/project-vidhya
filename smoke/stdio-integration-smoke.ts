 ...
 *   3. tools/list returns the expected 33 tools
...
(async () => {
  ...
  try {
    ...
    check('admin sees all 33 tools', toolsResp.result?.tools?.length === 33);
    ...
    check('response body has tool_count 33', capsBody.tool_count === 33);
