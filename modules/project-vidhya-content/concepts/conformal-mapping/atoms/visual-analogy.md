...
The diagram on this card shows the image of the circle $|z|=2$ under $w=1/z$: a smaller circle, traced in the opposite rotational direction. Every right angle on the original circle's grid still meets at a right angle on this image — the size and orientation changed, the angles didn't.
