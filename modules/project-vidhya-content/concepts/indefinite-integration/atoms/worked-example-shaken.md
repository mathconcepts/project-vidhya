...
Denominator's derivative: $\frac{d}{dx}[(x-1)(x+2)] = 2x+1$. Is $3x+5$ a multiple of $2x+1$? No. So substitution is not available — use partial fractions.
...
Put $x=1$: $3(1)+5 = A(1+2)$, so $8=3A$, so $A=\frac{8}{3}$.

## Solve for B

Put $x=-2$: $3(-2)+5 = B(-2-1)$, so $-1=-3B$, so $B=\frac{1}{3}$.
...
Differentiate the answer: $\frac{8/3}{x-1}+\frac{1/3}{x+2} = \frac{8(x+2)+(x-1)}{3(x-1)(x+2)} = \frac{9x+15}{3(x-1)(x+2)} = \frac{3x+5}{(x-1)(x+2)}$. Matches.
