...
$x_1+2x_2+3x_3=0$ is the only surviving constraint. Free variables $x_2,x_3$ give:
...
Rank 1 here means every row is a scalar multiple of every other — the matrix genuinely has one independent direction. That's the fast tell: if you can see the row dependence by inspection, you already know the rank without finishing the elimination.
