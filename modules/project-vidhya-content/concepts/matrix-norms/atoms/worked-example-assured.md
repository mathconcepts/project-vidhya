...
For $\kappa_2$: $A^TA = \begin{pmatrix}16&4\\4&5\end{pmatrix}$, $\lambda = \frac{21\pm\sqrt{185}}{2} \approx 18.3,\,2.7$, so $\sigma_{1,2}\approx4.28,\,1.64$.

$$\boxed{\|A\|_F \approx 4.58, \quad \|A\|_1 = 4, \quad \kappa_2(A) \approx 2.6}$$
...
**Sanity bound worth knowing:** $\|A\|_2 \le \|A\|_F$ always, since the spectral norm is one singular value and the Frobenius norm aggregates all of them — here $4.28 \le 4.58$ ✓, a one-line check against a sign error in the eigenvalue solve.
