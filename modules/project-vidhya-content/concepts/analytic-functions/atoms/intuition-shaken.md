...
Take $f(z)=z^2$ at $x=1,y=1$. Write $f=u+iv$: $u=x^2-y^2$, $v=2xy$. The four partials there: $u_x=2x=2$, $v_y=2x=2$ — equal. $u_y=-2y=-2$, $-v_x=-2y=-2$ — equal too. Those two equalities are the Cauchy–Riemann equations, and here both hold.
...
The two conditions to check, always together: both CR equalities, and continuity of the four partials — on an open set, not one point.
