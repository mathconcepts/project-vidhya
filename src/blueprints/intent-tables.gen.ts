...
export type TemplateFamilyId =
  ...
  | 'numerical' | 'discrete' | 'coordinate_geometry' | 'trigonometry' | 'algebra' | 'mechanics'
  | 'field_and_circuit' | 'wave_and_optics' | 'modern_physics' | 'chemistry_quantitative' | 'chemistry_structure' | 'chemistry_reaction';
...
export const CONCEPT_TEMPLATE_FAMILY: Record<string, TemplateFamilyId> = {
  'alcohols-phenols-ethers': 'chemistry_reaction',
  'aldehydes-ketones-acids': 'chemistry_reaction',
  'alternating-current': 'field_and_circuit',
  'amines-and-diazonium': 'chemistry_reaction',
  'analytic-functions': 'complex',
  'applications-of-derivatives': 'derivative',
  'atomic-structure': 'chemistry_quantitative',
  'atoms-and-nuclei': 'modern_physics',
  'binomial-theorem': 'algebra',
  'biomolecules': 'chemistry_reaction',
  'boolean-algebra': 'discrete',
  'capacitance': 'field_and_circuit',
  'cayley-hamilton': 'matrix',
  'chain-rule': 'derivative',
  'change-of-basis': 'matrix',
  'chemical-bonding': 'chemistry_quantitative',
  'chemical-kinetics': 'chemistry_quantitative',
  'circles-coordinate': 'coordinate_geometry',
  'complex-integration': 'complex',
  'complex-numbers': 'complex',
  'complex-numbers-algebra': 'complex',
  'conformal-mapping': 'complex',
  'continuity': 'limit',
  'continuity-differentiability-jee': 'derivative',
  'continuous-distributions': 'probability',
  'coordination-compounds': 'chemistry_structure',
  'counting-principles': 'probability',
  'current-electricity': 'field_and_circuit',
  'd-and-f-block': 'chemistry_structure',
  ...
  'differential-equations-jee': 'ode',
  'discrete-distributions': 'probability',
  'divergence-curl': 'vector',
  'dual-nature-matter': 'modern_physics',
  'eigenvalues': 'eigen',
  'electromagnetic-induction': 'field_and_circuit',
  'electromagnetic-waves': 'field_and_circuit',
  'electrostatics-coulomb': 'field_and_circuit',
  'equilibrium-chemical': 'chemistry_quantitative',
  'equilibrium-ionic': 'chemistry_quantitative',
  ...
  'haloalkanes-haloarenes': 'chemistry_reaction',
  'heights-distances': 'trigonometry',
  'hydrocarbons': 'chemistry_reaction',
  ...
  'magnetic-effects': 'field_and_circuit',
  ...
  'mole-concept': 'chemistry_quantitative',
  ...
  'organic-basic-principles': 'chemistry_reaction',
  'orthogonality': 'matrix',
  'oscillations-shm': 'wave_and_optics',
  'p-block-elements': 'chemistry_structure',
  'parabola-ellipse-hyperbola': 'coordinate_geometry',
  'partial-fractions': 'integral',
  'pde-basics': 'pde',
  'periodic-table-trends': 'chemistry_structure',
  'permutations-combinations': 'discrete',
  'planar-graphs': 'discrete',
  'polymers': 'chemistry_reaction',
  'positive-definite-matrices': 'matrix',
  'probability-basics': 'probability',
  'probability-jee': 'probability',
  ...
  'rank-nullity': 'matrix',
  'ray-optics': 'wave_and_optics',
  'recurrence-relations': 'discrete',
  'redox-and-electrochemistry': 'chemistry_quantitative',
  ...
  'semiconductor-electronics': 'modern_physics',
  'sequences': 'limit',
  ...
  'solid-state': 'chemistry_quantitative',
  'solutions-and-colligative': 'chemistry_quantitative',
  'spectral-theorem': 'eigen',
  'statistics-jee': 'statistics',
  'stokes-theorem': 'vector',
  'straight-lines': 'coordinate_geometry',
  'surface-integrals': 'vector',
  'svd': 'matrix',
  'symmetric-matrices': 'eigen',
  'systems-of-equations': 'matrix',
  'taylor-laurent': 'complex',
  'thermodynamics-chemistry': 'chemistry_quantitative',
  'thermodynamics-physics': 'mechanics',
  'three-d-geometry': 'vector',
  'trace': 'matrix',
  'trees': 'discrete',
  ...
  'vectors-jee': 'vector',
  'wave-optics': 'wave_and_optics',
  'waves-mechanical': 'wave_and_optics',
