---
id: parabola-ellipse-hyperbola.hook-assured
...
The focus-directrix ratio unifies three curves, but it quietly excludes a fourth member of the same family: at $e=0$, the "directrix" recedes to infinity and the definition degenerates — a circle is not reachable through this particular construction at all, even though it is the $a=b$ limit of the ellipse's own equation. Circle, ellipse, parabola, and hyperbola form one continuum by eccentricity in every property EXCEPT this one specific derivation.

A second subtlety worth keeping straight: eccentricity classifies the CURVE, not any one point on it. Every point on a given ellipse shares the identical $e<1$ ratio to its own focus and directrix — the ratio is a constant of the curve, never a per-point quantity that varies as you move along it, the way curvature does.
