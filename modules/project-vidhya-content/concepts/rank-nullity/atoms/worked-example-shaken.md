...
Find rank, nullity, a null space basis, and check rank-nullity.
...
**Nullity from the theorem.** $n=3$ columns, so $\text{nullity}(A)=3-1=2$.

---

**Find the null space directly.** The system reduces to one equation: $x_1+2x_2+3x_3=0 \Rightarrow x_1=-2x_2-3x_3$.
