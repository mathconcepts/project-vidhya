...
The discriminant's three-way split and Vieta's sum/product are familiar. The distinction that costs marks: $D \ge 0$ is necessary for both roots to be real, but it is nowhere near sufficient for a **location** claim like "both roots lie between $1$ and $5$".
