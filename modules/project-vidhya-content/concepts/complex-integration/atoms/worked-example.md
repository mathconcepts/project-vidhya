...
```interactive-spec
{"v":1,"kind":"guided_walkthrough","steps":[{"prompt":"Evaluate ∮_C 1/(z−2) dz where C is |z|=3 (counterclockwise). Is z=2 inside C?","hint":"Check |2| = 2 < 3. If the pole is inside, apply Cauchy's integral formula ∮ dz/(z−z₀) = 2πi.","answer":"Yes, |2|=2 < 3 so z=2 is inside C. By Cauchy's formula, ∮ dz/(z−2) = 2πi."},{"prompt":"Now evaluate ∮_C 1/(z−5) dz where C is still |z|=3. Is z=5 inside C?","hint":"Check |5|=5 > 3. If the singularity is outside the contour and f is analytic inside, Cauchy's theorem applies.","answer":"No, |5|=5 > 3 so z=5 is outside C. Since 1/(z−5) is analytic inside |z|=3, ∮ dz/(z−5) = 0."}]}
```
