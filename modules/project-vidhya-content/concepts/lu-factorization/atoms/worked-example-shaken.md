...
$A=\begin{pmatrix}4&3\\6&5\end{pmatrix}$. Doolittle form: $L=\begin{pmatrix}1&0\\\ell_{21}&1\end{pmatrix}$, $U=\begin{pmatrix}u_{11}&u_{12}\\0&u_{22}\end{pmatrix}$.

Row 1 of $LU$ is row 1 of $U$: $u_{11}=4$, $u_{12}=3$.

$\ell_{21}u_{11}=6 \Rightarrow \ell_{21}=3/2$. Then $\ell_{21}u_{12}+u_{22}=5 \Rightarrow u_{22}=1/2$.
