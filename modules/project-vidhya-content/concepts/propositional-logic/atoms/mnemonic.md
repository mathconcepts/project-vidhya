---
id: propositional-logic.mnemonic
...
**"An implication only lies when true leads to false."** That single sentence reproduces the whole $P\to Q$ table: the *only* false row is $P{=}T, Q{=}F$; every other combination — both true, or the antecedent false either way — is automatically true.
