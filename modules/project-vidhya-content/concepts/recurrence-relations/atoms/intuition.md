...
The recurrence's **characteristic equation** — the plain algebra equation you get by trying $a_n=r^n$ in the recurrence and cancelling the common power of $r$ — is $x^2-5x+6=0$, and it actually has **two** roots, $2$ and $3$. The general solution needs both: $a_n=c_1 2^n+c_2 3^n$. Two unknowns, two initial conditions — solve $c_1+c_2=2$ and $2c_1+3c_2=5$ to get $c_1=1,c_2=1$, giving $a_n=2^n+3^n$.
