  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
      ...
      <motion.div initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }}>
        ...
        <p style={{ margin: '4px 0 0', fontSize: 'var(--text-footnote)', color: 'var(--text-tertiary)' }}>
      ...
      <motion.div
        ...
        animate={{ opacity: 1, y: 0 }}
        style={{ padding: 20, borderRadius: 'var(--radius-md)', background: 'var(--indigo-tint)', border: 'var(--hairline) solid var(--indigo)' }}
      >
      ...
      >
        <div style={{ padding: 12, borderRadius: 'var(--radius-md)', background: 'var(--surface-card)', border: 'var(--hairline) solid var(--separator)', textAlign: 'center' }}>
          ...
          <p style={{ margin: 0, fontSize: 'var(--text-footnote)', color: 'var(--text-tertiary)' }}>problems solved</p>
        </div>
        <div style={{ padding: 12, borderRadius: 'var(--radius-md)', background: 'var(--surface-card)', border: 'var(--hairline) solid var(--separator)', textAlign: 'center' }}>
        ...
        <div style={{ padding: 12, borderRadius: 'var(--radius-md)', background: 'var(--surface-card)', border: 'var(--hairline) solid var(--separator)', textAlign: 'center' }}>
          ...
          <p style={{ margin: 0, fontSize: 'var(--text-footnote)', color: 'var(--text-tertiary)' }}>day streak</p>
        </div>
        <div style={{ padding: 12, borderRadius: 'var(--radius-md)', background: 'var(--surface-card)', border: 'var(--hairline) solid var(--separator)', textAlign: 'center' }}>
          ...
          <p style={{ margin: 0, fontSize: 'var(--text-footnote)', color: 'var(--text-tertiary)' }}>errors fixed</p>
        </div>
      </motion.div>
      ...
      <motion.div
        initial={{ opacity: 0, y: 8 }}
        animate={{ opacity: 1, y: 0 }}
        style={{ padding: 16, borderRadius: 'var(--radius-md)', background: 'var(--green-tint)', border: 'var(--hairline) solid var(--green)' }}
      >
        <p style={{ margin: '0 0 4px', fontSize: 'var(--text-footnote)', fontWeight: 'var(--weight-semibold)', color: 'var(--green-ink)' }}>Growth Proof</p>
      ...
      {digest.ugly_truth && (
        <motion.div
          initial={{ opacity: 0, y: 8 }}
          animate={{ opacity: 1, y: 0 }}
          style={{ padding: 16, borderRadius: 'var(--radius-md)', background: 'var(--orange-tint)', border: 'var(--hairline) solid var(--orange)' }}
        >
          <p style={{ margin: '0 0 4px', fontSize: 'var(--text-footnote)', fontWeight: 'var(--weight-semibold)', color: 'var(--orange)', display: 'flex', alignItems: 'center', gap: 4 }}>
      ...
      <motion.div
        initial={{ opacity: 0, y: 8 }}
        animate={{ opacity: 1, y: 0 }}
        style={{ padding: 16, borderRadius: 'var(--radius-md)', background: 'var(--indigo-tint)', border: 'var(--hairline) solid var(--indigo)' }}
      >
        <p style={{ margin: '0 0 4px', fontSize: 'var(--text-footnote)', fontWeight: 'var(--weight-semibold)', color: 'var(--indigo-ink)' }}>Your One Action This Week</p>
      ...
      >
        <p style={{ margin: '0 0 4px', fontSize: 'var(--text-footnote)', color: 'var(--text-tertiary)' }}>On your current trajectory</p>
        ...
        <p style={{ margin: '4px 0 0', fontSize: 'var(--text-footnote)', color: 'var(--text-tertiary)' }}>Range: {digest.predicted_score.range}</p>
      </motion.div>
    </div>
  );
}
