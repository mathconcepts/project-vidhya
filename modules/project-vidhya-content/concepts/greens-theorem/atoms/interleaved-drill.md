...
**Why this drill exists:** students learn divergence-curl's curl formula and Green's Theorem's density $\partial_xQ-\partial_yP$ as two unrelated facts to memorize separately, when the second is nothing but the $\hat k$-component of the first for a field with $R=0$ and no $z$-dependence — precisely the case Green's Theorem restricts itself to.
