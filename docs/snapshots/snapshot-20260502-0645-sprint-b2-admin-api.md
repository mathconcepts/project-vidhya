# Snapshot snapshot-20260502-0645-sprint-b2-admin-api

| Field | Value |
|---|---|
| Tag | `snapshot-20260502-0645-sprint-b2-admin-api` |
| Git branch | `claude/deployment-framework-setup-94Pfr` |
| Git SHA | `1c1c068589ca16ccc22635b9137b050ba5a04dbd` |
| Created (UTC) | 2026-05-02T06:46:00Z |
...
| Docker image | `project-vidhya:snapshot-20260502-0645-sprint-b2-admin-api` |
...
```bash
# Local re-run:
docker run -p 8080:8080 --env-file .env project-vidhya:snapshot-20260502-0645-sprint-b2-admin-api

# Or roll back to this exact code:
git checkout snapshot-20260502-0645-sprint-b2-admin-api
```
