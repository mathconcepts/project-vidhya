...
Take $y' - y = xy^2$, the running example on this card: substituting $v = y^{-1}$ turns it into a straight line for $v$ — and unwinding that line back to $y$ reveals something a linear equation by itself never shows.
