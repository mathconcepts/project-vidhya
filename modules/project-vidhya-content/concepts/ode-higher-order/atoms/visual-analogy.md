...
The diagram on this card shows $(1+x+x^2)e^{x}$, the triple-root solution with $C_1=C_2=C_3=1$ — it's not a straight exponential curve near $x=0$, where the polynomial passenger still has a say.
