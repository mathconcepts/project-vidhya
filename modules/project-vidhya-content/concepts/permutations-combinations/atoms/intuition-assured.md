...
The counting principle, and the permutation-versus-combination split, are familiar. The distinction that costs marks: "at least one" restrictions cannot be counted the same way "all together" restrictions are — trying it directly usually double-counts.
