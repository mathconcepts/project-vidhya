...
Take a row from the first matrix and a column from the second. Multiply matching entries, add them up — that's one number of the answer. Repeat for every row and column.
