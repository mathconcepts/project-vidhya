...
$A$ is $2\times2$. $B$ is $2\times3$. Columns of $A$ match rows of $B$ — both $2$ — so $AB$ exists and is $2\times3$.

## Fill in $AB$ one entry at a time

Row 1 of $A$ is $(2,1)$. Match it against each column of $B$:
...
Row 1 of $AB$ becomes column 1 of $(AB)^T$; row 2 becomes column 2:

$$(AB)^T = \begin{pmatrix} 1 & 4 \\ 2 & -2 \\ 5 & 5 \end{pmatrix}$$

That's the answer. A quick check: $(AB)^T$ also equals $B^TA^T$ — same numbers, reached the other way round.
