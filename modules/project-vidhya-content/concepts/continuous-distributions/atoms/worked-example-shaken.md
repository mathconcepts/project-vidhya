...
id: continuous-distributions.worked_example.shaken
...
## Part A — set it up first

$X\sim N(50,16)$, so $\sigma=4$. Want $P(46<X<58)$. Before computing anything, standardize both ends: $Z=\frac{46-50}{4}=-1$ and $Z=\frac{58-50}{4}=2$.

## Now read the table

$P(46<X<58)=\Phi(2)-\Phi(-1)=0.9772-(1-0.8413)=0.9772-0.1587=0.8185$.

## Check

A probability must sit in $[0,1]$: $0.8185$ does. It's also close to a "within roughly $1\sigma$ to $2\sigma$" range, matching the bell-curve picture.

## Part B — same setup discipline

$T\sim\text{Exp}(\lambda)$, mean $500\Rightarrow\lambda=1/500=0.002$. Want $P(T\le300)$: $P(T\le t)=1-e^{-\lambda t}$, so $P(T\le300)=1-e^{-0.6}=1-0.5488=0.4512$.

## Check

$0.4512\in[0,1]$. Even with a 500-hour mean, a 45% chance of failing before 300 hours is real — the exponential decays fastest early on.
