...
id: determinants.worked_example.assured
...
## $3\times3$, by row reduction

**Problem:** Compute $\det(A)$ for $A = \begin{pmatrix} 2 & 1 & -1 \\ 1 & 3 & 2 \\ -1 & 2 & 0 \end{pmatrix}$

Cofactor expansion works, but row-reduce instead — it scales, and adding multiples of rows costs you nothing.
...
$$\det(A) = 2 \cdot \tfrac52 \cdot (-3) = \boxed{-15}$$
