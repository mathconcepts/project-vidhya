...
The trap that actually costs marks: assuming linearity is decided by the highest-order derivative alone. It isn't. $y'' + y\,y' = 0$ has $y''$ appearing to the first power, which tempts a "linear" verdict — but the product $y\,y'$ alone makes the whole equation non-linear, regardless of every other term's good behaviour. Check every term, not just the leading one.
