...
Similarly, **Green's Theorem says**: the line integral of a vector field around a closed curve equals the double integral of the field's curl over the enclosed region — whirlpools, tornadoes, and rotating machinery all obey the same rule, whatever the boundary is shaped like.
