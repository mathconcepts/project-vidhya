...
**Verify the numbers.** At $x=0.5$: $\dfrac{2(0.5)}{1+0.25}=\dfrac{1}{1.25}=0.8$, so $y=\sin^{-1}(0.8)\approx0.9273$. Compute $2\tan^{-1}(0.5)$ separately: also $\approx0.9273$. They match.
