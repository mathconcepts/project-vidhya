...
```interactive-spec
{"v":1,"kind":"guided_walkthrough","steps":[{"prompt":"X ~ N(100, 25) (so σ = 5). Find P(X > 110).","hint":"Standardize: Z = (110 − 100) / 5 = 2. Then P(X > 110) = P(Z > 2) = 1 − Φ(2). Use Φ(2) ≈ 0.9772.","answer":"Z = (110 − 100) / 5 = 2. P(X > 110) = 1 − Φ(2) = 1 − 0.9772 = 0.0228. About 2.28% of values exceed 110."},{"prompt":"A component has exponential lifetime with mean 200 hours. What is the probability it survives beyond 400 hours?","hint":"λ = 1/200. P(T > t) = e^{−λt}. Substitute t = 400. Note that 400 = 2 × mean.","answer":"λ = 1/200. P(T > 400) = e^{−(1/200)·400} = e^{−2} ≈ 0.1353. Only about 13.5% of components last twice their mean lifetime — the exponential distribution decays quickly."}]}
```
