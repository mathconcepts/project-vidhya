...
```interactive-spec
{"v":1,"kind":"guided_walkthrough","steps":[{"prompt":"For K₄ (V=4, E=6), what is the number of faces F in a planar drawing? Use Euler's formula to compute F.","hint":"Euler's formula: V - E + F = 2. Substitute V=4 and E=6 and solve for F.","answer":"V - E + F = 2 → 4 - 6 + F = 2 → F = 4. There are 4 faces: three inner triangular regions and one outer (infinite) face."},{"prompt":"Show that K₅ is non-planar using the inequality 3F ≤ 2E. If K₅ were planar, what would F be, and why does this give a contradiction?","hint":"First use Euler's formula to find F if K₅ were planar (V=5, E=10). Then check whether 3F ≤ 2E holds.","answer":"If planar: 5 - 10 + F = 2 → F = 7. Check: 3F = 21 but 2E = 20. Since 21 > 20, the inequality 3F ≤ 2E is violated — contradiction. K₅ cannot be planar."}]}
```
