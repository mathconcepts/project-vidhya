...
$$P(X = 1) = \sum_y P(X = 1, Y = y) = P(X=1, Y=1) + P(X=1, Y=2) = 0.2 + 0.3 = 0.5$$

We can verify the marginal for $X = 2$: $P(X = 2) = 0.1 + 0.4 = 0.5$. And the total: $0.5 + 0.5 = 1$ ✓ (as required for a valid PMF).
