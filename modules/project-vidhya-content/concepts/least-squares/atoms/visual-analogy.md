...
The curve on this card bottoms out at $m=1/2$, exactly the slope the normal equations produced. Moving $m$ either direction from there strictly increases the total error.
