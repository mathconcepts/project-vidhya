---
id: matrices-and-determinants.worked-example-shaken
...
**Step 1.** Write $A=\begin{pmatrix}1&1&1\\1&-1&1\\1&2&-1\end{pmatrix}$. Expand along row 1:

$$\Delta=1(-1-2)-1(-1-1)+1(2+1)$$

Work each $2\times2$ piece separately: $\begin{vmatrix}-1&1\\2&-1\end{vmatrix}=(-1)(-1)-(1)(2)=1-2=-1$. $\begin{vmatrix}1&1\\1&-1\end{vmatrix}=(1)(-1)-(1)(1)=-1-1=-2$. $\begin{vmatrix}1&-1\\1&2\end{vmatrix}=(1)(2)-(-1)(1)=2+1=3$.

$$\Delta=1(-1)-1(-2)+1(3)=-1+2+3=4$$

$\Delta=4\neq0$, so continue.

**Step 2.** Replace column 1 (the $x$-column) with $(6,2,2)$:

$$\Delta_x=\begin{vmatrix}6&1&1\\2&-1&1\\2&2&-1\end{vmatrix}=6(-1)-1(-2-2)+1(4+2)=-6+4+6=4$$

**Step 3.** Replace column 2, then column 3, the same way:

$$\Delta_y=\begin{vmatrix}1&6&1\\1&2&1\\1&2&-1\end{vmatrix}=1(-4)-6(-2)+1(0)=-4+12+0=8$$

$$\Delta_z=\begin{vmatrix}1&1&6\\1&-1&2\\1&2&2\end{vmatrix}=1(-6)-1(0)+6(3)=-6-0+18=12$$

**Step 4.** Divide each by $\Delta=4$:

$$x=\frac44=1,\quad y=\frac84=2,\quad z=\frac{12}{4}=3$$

$$\boxed{x=1,\ y=2,\ z=3}$$

**Check:** $1+2+3=6$ ✓, $1-2+3=2$ ✓, $1+4-3=2$ ✓.
