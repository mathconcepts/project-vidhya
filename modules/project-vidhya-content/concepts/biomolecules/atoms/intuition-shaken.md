---
id: biomolecules.intuition-shaken
...
So "made of glucose" is not enough information on its own. The exact linkage geometry between the units is what decides whether the resulting chain is digestible or not — check that, not just the building block.
