...
Take $A=\begin{pmatrix}1&2\\0.5&1\end{pmatrix}$. Every arrow that goes in lands somewhere on one line — the direction $(1,0.5)$, stretched to $(2,1)$. One direction, $(2,-1)$, lands exactly at $(0,0)$: gone. One line survives, one direction dies. Rank counts what survives: $1$. Nullity counts what's crushed: $1$. $1+1=2$, the full plane.
